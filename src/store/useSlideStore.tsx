...
interface SlideState {
    ...
    updateContentItem: (slideId: string, contentId: string, content: string | string[] | string[][]) => void
...
export const useSlideStore = create(
    persist<SlideState>((set, get) => ({
              ...
              const updatedSlides = state.slides.map((slide) => {
                if (slide.id === slideId) {
                  const updateContentRecursively = (
                    ...
                    if (content.id === parentId && Array.isArray
                    (content.content)) {
        ...
        {
            name: 'slide-storage', // unique name for the storage
        })
