...
import { Home, HomeIcon, Play, Share } from "lucide-react";
  ...
  return (
    ...
    >
      <Link href={"/dashboard"} passHref>
        ...
        >
          {/*add a custom home button by downloading the home button image and putting it in icons folder */}
